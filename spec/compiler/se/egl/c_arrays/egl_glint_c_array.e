...
feature {NONE} -- Initialization
	...
	make_empty (size: INTEGER) is
			-- Create an empty GLint C array with the given `size'. 
		require
			valid_size: size > 0
		do
			count := size
...
feature -- Basic operations	
	...
	array_has_convertable_values (a: ARRAY [INTEGER]): BOOLEAN is
			...
			-- GLuint? 
		do
			-- Assuming Eiffel INTEGER = C long and GLint =
