...
feature {NONE} -- Implementation (GLUT callbacks)	
	...
	on_keyboard (char: CHARACTER; modifier, x_pos, y_pos: INTEGER) is
	...
	on_motion (x_pos, y_pos: INTEGER) is
...
feature {NONE} -- Implementation
	...
	init_display_list (animate: INTEGER) is
...
feature -- Debug
	...
	ptf: PLAIN_TEXT_FILE is
		once
			!! Result.make_open_write ("dragnet2k.out")
		end
