...
feature -- Initialization	
	...
	init_from_points (p1, p2: TUPLE [DOUBLE]) is
	...
	init_normalized_crossproduct (p1, p2, p3: TUPLE [DOUBLE]) is
		...
		do
			!! v1.init_from_points (p1, p2)
			!! v2.init_from_points (p1, p3)
			n := v1 # v2
			n.normalize			
			make
			resize (1, 3)
...
feature -- Access	
	...
	length, size, magnitude: DOUBLE is
			-- Length
		local
			i: INTEGER
			sum: DOUBLE
...
feature	-- Basic operations
	...
	infix "#", cross_product, vector_product (other: like Current): like Current is
...
feature -- Test & debug	
	...
	test1 is
		...
		do			
			...
			!! v1.init_from_points ([0.0,0.0,0.0], [2.0,0.0,0.0])
			print ("v1 = ")
			print (v1.out)
			print ("%N")
			
			!! v2.init_from_points ([0.0,0.0,0.0], [0.0,2.0,0.0])
			print ("v2 = ")
			print (v2.out)
			print ("%N")
