...
feature {NONE} -- Implementation
    ...
    normals: ARRAY [TUPLE_BASED_VECTOR]
        local
            n: TUPLE_BASED_VECTOR
        once
            create Result.make (1, 7)

            create n.init_normalized_crossproduct (vertices @ 1, vertices @ 5, vertices @ 6)
            Result.put (n, 1)
            create n.init_normalized_crossproduct (vertices @ 4, vertices @ 9, vertices @ 5)
            Result.put (n, 2)
            create n.init_normalized_crossproduct (vertices @ 4, vertices @ 3, vertices @ 9)
            Result.put (n, 3)
            create n.init_normalized_crossproduct (vertices @ 2, vertices @ 3, vertices @ 7)
            Result.put (n, 4)
            create n.init_normalized_crossproduct (vertices @ 1, vertices @ 2, vertices @ 6)
            Result.put (n, 5)
            create n.init_normalized_crossproduct (vertices @ 6, vertices @ 7, vertices @ 10)
            Result.put (n, 6)
            create n.init_normalized_crossproduct (vertices @ 1, vertices @ 2, vertices @ 5)
            Result.put (n, 7)
        end
