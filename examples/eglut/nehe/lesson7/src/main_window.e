...
feature {NONE} -- Initialization
	...
	init is
		...
		do
			...
			-- the texture and when the texture mapped surface is
			...
			-- case. Mipmapping is good when the textured image is
...
feature {NONE} -- Implementation	
	...
	texture_file_name: STRING is
		once
			Result := ".\crate_bgr.tga"
		end
