...
feature -- Access (Image information)	
	...
	x_orientation_is_left: BOOLEAN is
	...
	y_orientation_is_bottom: BOOLEAN is
...
feature {NONE} -- Implementation
	...
	tga_info: TGA_INFO_STRUCTURE is
			-- A tga_info C structure
		once
			!! Result.make
		end
	
	tga: TGA_STRUCTURE is
			-- A tga C structure
		once
			!! Result.make
		end
...
feature {NONE} -- Implementation (externals)	
	...
	c_tga_read_tga (ptr, info: POINTER; flags: INTEGER) is
		external
	...
	c_tga_read_info (ptr, info: POINTER; flags: INTEGER) is
		external
			"C [macro %"tga.h%"] (tga_ptr, tga_info_ptr, tga_uint_32)"
		alias
			"tga_read_info"
	...
	c_tga_get_x_orientation (info: POINTER) : INTEGER is
		external
	...
	c_tga_get_y_orientation (info: POINTER): INTEGER is
		external
			"C [macro %"tga.h%"] (tga_info_ptr): tga_uint_8"
		alias
