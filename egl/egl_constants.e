...
feature -- Status report	
	...
	is_valid_clearing_buffer (buffer: INTEGER): BOOLEAN is
	...
	is_valid_geometric_primitive (mode: INTEGER): BOOLEAN is
	...
	is_valid_orientation_mode (mode: INTEGER): BOOLEAN is
	...
	is_valid_face (face: INTEGER): BOOLEAN is
	...
	is_valid_matrix_mode (mode: INTEGER): BOOLEAN is
	...
	is_valid_shading_mode (mode: INTEGER): BOOLEAN is
	...
	is_valid_material_property (property: INTEGER): BOOLEAN is
	...
	is_valid_light (light: INTEGER): BOOLEAN is
	...
	is_valid_light_property (property: INTEGER): BOOLEAN is
	...
	is_valid_light_model_property (property: INTEGER): BOOLEAN is
...
--				(property = Gl_light_model_color_control)
	...
	is_valid_material_color_mode (mode: INTEGER): BOOLEAN is
	...
	is_valid_destination_blending_factor (factor: INTEGER): BOOLEAN is
