...
feature -- Basic operations 
    ...
    array_has_convertable_values (a: ARRAY [REAL]): BOOLEAN
...
feature {NONE} -- Implementation    
    ...
    c_put_real_in_glfloat_array (p: POINTER; i: INTEGER; r: REAL)
    ...
    c_real_in_glfloat_array (p: POINTER; i: INTEGER): REAL
